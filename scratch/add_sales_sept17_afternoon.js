...
async function addSalesSept17Afternoon() {
    try {
        console.log('Starting to add sales for Sept 17 (15:00 - 23:00)...');
        ...
        const numSales = 20; // exactly 20 bills
        console.log(`Generating ${numSales} sales...`);
        
        // Generate timestamps for Sept 17, 15:00 - 23:00 (TH Time)
        // UTC: 2026-09-17 08:00:00 to 2026-09-17 15:59:59
        const timestamps = [];
        const minTime = new Date('2026-09-17T08:00:00Z').getTime(); 
        const maxTime = new Date('2026-09-17T15:59:59Z').getTime();
        ...
        console.log(`Successfully generated ${numSales} sales for Sept 17 afternoon with strict inventory and logical checks.`);
        process.exit(0);
