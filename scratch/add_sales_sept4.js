...
async function addSalesSept4() {
    try {
        console.log('Starting to add sales for Sept 4...');
        ...
        // Generate timestamps for Sept 4, 06:00 - 23:00 (TH Time)
        // UTC: 2026-09-03 23:00:00 to 2026-09-04 15:59:59
        const timestamps = [];
        const minTime = new Date('2026-09-03T23:00:00Z').getTime(); 
        const maxTime = new Date('2026-09-04T15:59:59Z').getTime();
        ...
        console.log(`Successfully generated ${numSales} sales for Sept 4.`);
        process.exit(0);
