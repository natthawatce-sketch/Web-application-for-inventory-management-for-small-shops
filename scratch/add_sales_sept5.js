...
async function addSalesSept5() {
    try {
        console.log('Starting to add sales for Sept 5...');
        ...
        // Generate timestamps for Sept 5, 06:00 - 23:00 (TH Time)
        // UTC: 2026-09-04 23:00:00 to 2026-09-05 15:59:59
        const timestamps = [];
        const minTime = new Date('2026-09-04T23:00:00Z').getTime(); 
        const maxTime = new Date('2026-09-05T15:59:59Z').getTime();
        ...
        console.log(`Successfully generated ${numSales} sales for Sept 5.`);
        process.exit(0);
